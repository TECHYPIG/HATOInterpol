                                            ...
                                            <div class="card">
												<div class="card-header">
                                                    <div class="form-group">
                                                        <form method="post">    
                                                            <input type="text" name="message" class="form-control thresold-i" placeholder="Type your keywords..." maxlength="20">    
                                                            <button name="submit" type="submit" value="announce" class="btn waves-effect waves-light btn-primary btn-block">Post Announcement</button>  
                                                        </form>     
                                                    </div>
                                                </div>
								            </div>
