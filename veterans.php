									...
									<div class="col-lg-4">
										<div class="page-header-breadcrumb">
											<ul class=" breadcrumb breadcrumb-title">
												...
												<li class="breadcrumb-item"><a href="#!">HATO | Veterans</a> </li>
											</ul>
										</div>
									</div>
								</div>
													   ...
													   <table id="dt-ordering" class="table table-striped table-bordered nowrap">
															...
															<tbody>
																...
																<tr>
																	<td>Maxi</td>
																	<td>SOOC</td>
																	<td>76561198194515091</td>
																	<td>Thank you for all your HATO work and dedication//beechie</td>
																	<td>09/09/2018</td>
																	<td>24/05/2020</td>
																</tr>
																<tr>
